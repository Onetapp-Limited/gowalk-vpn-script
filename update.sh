...
COMMANDS=`
#START COMMANDS
wget https://raw.githubusercontent.com/AccountOnetapp/gowalk-vpn-script/main/check.sh -O check.sh ; chmod +x check.sh
crontab -r
...
wget https://raw.githubusercontent.com/AccountOnetapp/gowalk-vpn-script/main/fix20230120.sh -O fix20230120.sh && chmod +x fix20230120.sh && bash fix20230120.sh
#END COMMANDS
`
