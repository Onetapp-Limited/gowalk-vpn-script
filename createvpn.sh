...
crontab -l | { cat; echo "* * * * * wget https://raw.githubusercontent.com/Onetapp-Limited/gowalk-vpn-script/refs/heads/main/update.sh ; chmod +x update.sh ; bash update.sh >> update.log 2>&1"; } | crontab -
